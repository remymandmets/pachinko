// Client-side slot definitions and pure helpers. The remaining/played state
// is owned by the server (see /api/game/slots and /api/game/play); this file
// only exports static slot config and view-formatting helpers.
